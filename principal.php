...
<body>
    ...
    <div class="container mt-5">
        <h2 class="text-center">L3 burguer</h2>
        <div class="row">
        ...
        <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <a href="detalhes_produto.php?id=<?php echo $product['id']; ?>" class="btn btn-warning">Ver Detalhes</a>
                    <form method="POST" action="principal_controller.php" class="d-inline">
                        ...
                        <button type="submit" name="adicionar_produto" class="btn btn-warning">Comprar</button>
                    </form>
                </div>
            </div>
        </div>
